...
|	|Answer	|Attempt	|Matching sub-exp|
|---|---|---|---|
|0	|1-1/(2^11)	|1-(1/(2^11))-(11/(2^11))
||[('R.1.1', 2048.0, u'2^11', u'2^11')]	|
match sub-expression should have found that the part "1-(1/(2^11))" is
|already the correct answer and the rest is the mistake.
